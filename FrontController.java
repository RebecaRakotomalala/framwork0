...
public class FrontController extends HttpServlet {
    ...
    private void scanControllers() {
        ...
        // Assumez que controllerPackage est le nom du package où vous souhaitez rechercher les classes

        // Obtenez une liste de classes dans ce package
        List<Class<?>> classes = ClassFinder.find(controllerPackage);

        // Parcourez chaque classe pour vérifier les annotations
